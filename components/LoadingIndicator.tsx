...
export const COLORS = {
  lightBlue: "rgb(217,243,253)",
  blue: "rgb(159,223,249)",
  darkBlue: "rgb(76,169,246)",
  lightGreen: "rgb(203,244,232)",
  green: "rgb(91,198,129)",
};
...
export function LoadingIndicator({ enabled }: LoadingIndicatorProps) {
  ...
  useEffect(() => {
    loading.value = withTiming(enabled == "loading" ? 1 : 0, {
